...
This script is primarily meant to be used in a custom COSMIC keyboard shortcut, but you can also put it behind an alias if you want to run it in the terminal without a shortcut.

I intend on converting this to Rust and then, if not done, contributing it to COSMIC.
